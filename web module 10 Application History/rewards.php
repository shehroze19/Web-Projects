...
<body>
	...
	<div class="container">
			...
			<table id="myTable" class="table" border="2">
				<tr class="header">
					...
					<th style="width:20%;">Scholarship Type</th>
					<th style="width:20%;">Medal Award Type</th>

					
					<th style="width:20%;">Sports Award</th>
					<th style="width:20%;">Other Achievements</th>
	...
	<?php
									$query2="SELECT * FROM reward_system ";
									...
									while($row = mysqli_fetch_array($result))
									{
										...
										echo "<td>" . $row['r_id'] . "</td>";
										echo "<td>" . $row['scholarship_reward'] . "</td>";
