		...
		if(isset($_POST['checked']))
		{
			...
			if(isset($_POST['checkbox'])){
				...
				for($i=0;$i<count($checkbox);$i++){
					...
					$sql = "DELETE FROM  `main_ad` WHERE `id`='$update_id'";
		...
		<form action="" method="post">
			...
			<table id="myTable" class="table-responsive" border="3">
				<tr class="header">
					...
					<th class="text-center active" style="width:15%;">Ad Name</th>
					<th class="text-center active" style="width:15%;">Description Name</th>
					...
					while($row = mysqli_fetch_assoc($result))
					{
						...
						echo "<td class='text-center'><img src='horizontal_ad_images/" .  $row['image'] . "'></img></td>";
				...
				<div class="form-group"><input type="Submit" name="checked" value="Delete Selected Ad" class="btn btn-block alert-success"></div>
