...
if (isset($_POST['upload'])) {
	$target = "brand_images/".basename($_FILES['image']['name']);
	...
	$sql = "INSERT INTO brand (brand_image,Name) VALUES ('$image', '$image_text')";
	mysqli_query($db, $sql);

	if (move_uploaded_file($_FILES['image']['tmp_name'], $target) ) {
		$msg = "Image uploaded successfully";
		echo "<div class='btn-primary text-center'>Brand Added</div><br><br><br>";
	}else{
