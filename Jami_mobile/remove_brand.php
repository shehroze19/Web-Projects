...
<body>
	...
	<div class="container-fluid">
		...
		if(isset($_POST['checked']))
		{
			...
			if(isset($_POST['checkbox'])){
				...
				for($i=0;$i<count($checkbox);$i++){
					...
					$sql = "DELETE FROM  `Brand` WHERE `id`='$update_id'";
					$result = mysqli_query($con,$sql);
				}


				if($result){
					echo "<div class='btn btn-block alert-success'>Brand Deleted</div>";
				}
				else
				{
					echo "Error";
		...
		<div class="page-header text-center">
			<h2 style="color:white;">All Brands</h2>
		...
		<form action="" method="post">
			...
			<table id="myTable" class="table-responsive" border="3">
				<tr class="header">
					...
					<th class="text-center active" style="width:30%;">Brand Name</th>
					...
					while($row = mysqli_fetch_assoc($result))
					{
						...
						echo "<td class='text-center'><img src='brand_images/" .  $row['brand_image'] . "'></img></td>";
				...
				<div class="form-group"><input type="Submit" name="checked" value="Delete Selected Brands" class="btn btn-block alert-success"></div>
