			...
			<div class="banner-info">
				...
				<div class="banner-text text-center">
					...
					<div class="form-group row">
						<form action="update_admin_complete.php" method="post">

							<table  class="table">

								<tr class="">
									<th>Name</th>
									<td><input type="text" class="form-control text-center" name="name" value="<?php  echo $data['aName']?>" required></td>
								</tr>
					...
					<div>
						<a href="details_admin.php"><button class="btn btn-block btn-info">Click to go back to details page</button></a>
					</div>
