			...
			<div class="banner-info">
				...
				<div class="banner-text text-center">
					...
					if(count($_POST)>0){
						...
						$uid=(int)$_POST['ouruid'];
						$qid=(int)$_POST['ourqid'];
						$reply=$_POST['reply'];
						...
						$query="INSERT INTO `inbox`(`uId`,`qId`,`message`) VALUES ('$uid','$qid','$reply')";
						...
						if($runner){
							...
							$query2="UPDATE `queries` SET `replied`=1 where `qId`='$qid'";

						$runner2=mysqli_query($con,$query2);
						if($runner2){

							echo "<div class='btn btn-block alert-success'>Replied to the Query</div>";
					...
					echo "<a href='query_admin.php'>'<div class='btn btn-block alert-info'>Click here to go back</div></a>";
