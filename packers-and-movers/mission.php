...
<div class="text-center"><img id="change" style="height: 350px;width: 900px;" src="images/mission.jpg" ></div>
<br><hr class="btn-info">

<div class="row">

	<div id="details" class="col-md-2">
		<div class="btn-primary text-center">Our Services</div>
		<marquee class="table-bordered"   direction="up" scrollamount="6.5"  onMouseOver="this.stop();" onMouseOut="this.start();">
			...
			<br>
			<br>
			<div class="text-center alert-info">Logistic Services</div>
	...
	<div id="intro" class="col-md-10">

		<h2 class="text-center btn-info">Our Mission</h2>

		<div class="row">
			<div class="col-md-3">
				<div class="text-center"><img style="height: 180px;width: 225px;" src="images/mission.png"></div>
			</div>
			...
			<div class="col-md-9">
				...
				<p>Our mission is simple - to exceed our customers' highest expectations. For years we have been an industry leader, always striving to be on the cutting-edge of quality, technology and expert service. We understand that our clients and customers expect service excellence, but are also looking for more creative solutions and reduced costs. We believe that our vision can have a specific and dramatic impact on your moving program.
				</p></div>
