						...
						<div class="banner-text text-center">
							...
							?>
								...
								<tr >
									...
									<td><input type="text" class="form-control text-center" value="Admin" required readonly > </td>
								</tr>
											...
											<div>
												<a href="update_admin.php"><button class="btn btn-block btn-info">Modify Account Details</button></a>
											</div>
