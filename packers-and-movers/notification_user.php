...
<tr>
											<th class='bg-primary text-center' >Notification Message</th>
											<th class='bg-primary text-center'>Time Posted:</th>
											</tr>
										<?php 

										$result=mysqli_query($con,"select * from notification ORDER BY nDate ASC");
										...
										while($row=mysqli_fetch_assoc($result)){
											...
											echo "	
											<tr>
											<td class='text-center'> ".$row['notification']."</td>
											<td class='text-center'> ".$row['nDate']."</td></tr>";
