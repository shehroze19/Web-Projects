...
<div class="login-page">
  <div class="form">
    ...
    <form action="register_complete.php#here" method="post" class="login-form" >
      <input type="text" name="Name" class="text-center" placeholder="name" required/>
      <input type="text" name="Username" class="text-center" placeholder="username" required/>
      <input class="text-center" type="password" name="Password" placeholder="password "  required/>
      <input type="email" name="Email" class="text-center" placeholder="email" required/>
      <input type="text" name="address" class="text-center" placeholder="address" required/>
      <input type="text" name="phone" class="text-center" placeholder="telephone" required/>
      <button type="submit">Sign Up</button>
      <p class="message">Already registered? <a href="login.php">Log in Now!</a></p>
    </form>
  </div>
</div>
