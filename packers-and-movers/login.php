...
if(isset($_SESSION['Username'])){
	...
	$query="SELECT uUsername FROM user where uUsername='$sessionuser'";
	...
	if($count == 1) {
		...
		header("location: welcome.php#here");
	}
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$query="SELECT * FROM `user` where uUsername='$myusername' AND uPassword='$mypassword'";
	$result = mysqli_query($con,$query);
	$row = mysqli_fetch_array($result);
...
<div id="here"  class="login-page">
  <div class="form">
    ...
    <form action="#here"   method="post" class="login-form">
      ...
      <p class="message"><a href="login_admin.php">Login as Adminstrator here</a></p>
    </form>
  </div>
</div>
