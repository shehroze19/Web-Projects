			...
			<div class="banner-info">
				...
				<div class="banner-text text-center">
					...
					if(count($_POST)>0){
						...
						$query="UPDATE `user` SET `uName`='$name',`uAddress`='$address',`phone`='$phone',`uEmail`='$email' where `uUsername`='$user';";


						$runner=mysqli_query($con,$query);

						if($runner){
							echo "<div class='btn btn-block alert-success'>Personal Details Modified</div>";
							echo "<a href='update.php'><div class='btn btn-block alert-info'>Click here to go back</div></a>";
