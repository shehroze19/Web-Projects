			...
			<div class="banner-info">
				...
				<div class="banner-text text-center">
					...
					if(count($_POST)>0){
						...
						$query="UPDATE `admin` SET `aName`='$name',`phone`='$phone' where `aUsername`='$user';";
						...
						if($runner){
							...
							echo "<a href='update_admin.php'><div class='btn btn-block alert-info'>Click here to go back</div></a>";
