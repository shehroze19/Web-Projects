...
$sql = "UPDATE `dealbook` SET `is_active`=0 WHERE id='$id'";
...
<div class="container">
        ...
        <?php
                ...
                $result=mysqli_query($con,"SELECT * FROM `dealbook` WHERE is_active=0 AND id!=23");
...
?>
        ...
        <table  class="table table-responsive">
                ...
                while($row=mysqli_fetch_assoc($result)){
                   ...
                   echo '<td><form method="post" action="registeredcompany.php">';
                  
                   
                     echo ' <input type="submit" name="name" value="Deactivate">';
