                    ...
                    <nav class="navbar navbar-default btn">
                        <div class="container-fluid">
                            <ul class="nav navbar-nav btn">
                                <li><a href="unregistered_company.php" ><span>Unregistered</span></a></li>
                                <li><a href="registeredcompany.php" ><span>Registered</span></a></li>
...
<div class="container">
            ...
            <div class="form-group row">
                ...
                <h3>Choose either Unregistered or Registered Company for verification</h3></a>
            </h4>
        </div>
