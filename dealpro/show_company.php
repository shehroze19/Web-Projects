...
<!-- End page header -->
 <div class="container">
            ...
            <div class="form-group row">
                ...
                <h3>Company Information</h3></a>
            </h4>
        </div>
<?php
$compid = $_GET['id'];
$result=mysqli_query($con, "SELECT * FROM `dealbook` WHERE id='$compid'");
...
<table  class='table table-responsive'>
                ...
                <tr >
                    <th class='black'>Owner name</th>
                    <td>".$array['owner_name']."  </td>
                </tr>
                

                <tr >
                    <th class='black'>Designation</th>
                    <td>".$array['designation']."  </td>
                </tr>

                <tr >
                    <th class='black'>City</th>
                    <td>".$city_array['city_name']."  </td>
                </tr>
                <tr >
                ...
                <tr >
                    <th class='black'>Specialty</th>
                    <td>".$array['specialty']."  </td>
                </tr>


                <tr >
                    <th class='black'>Contact Number</th>
                    <td>".$array['mobile']."</td>
                </tr>
            </table>
";
