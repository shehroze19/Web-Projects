	...
	<div class="container">
		<div class="row">
			<div class="page-head-content">
				<h1 class="page-title">Deal Book</h1>               
			</div>
		</div>
	</div>
</div>
...
<div class="row">
    ...
    echo "0 results";
			...
			{
				$query="INSERT INTO `dealbook`(`company_name`, `address`, `owner_name`, `designation`, `email`, `specialty`,`mobile`, `phone`,`city_id`,`used`,`is_active`) VALUES ('$cname','$address','$owner','$designation','$email','$special','$mobile','$telephone','$city_id',0,1)";
			...
			if($runner){
				...
				echo "<meta http-equiv='refresh' content='3;url=adminhome.php'>";
