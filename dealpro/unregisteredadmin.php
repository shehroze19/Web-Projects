...
$sql = "UPDATE users SET is_active='1' WHERE username='$checkbox'";
...
<div class="container">
        ...
        <?php
                ...
                $result=mysqli_query($con,"SELECT * FROM `users` WHERE is_active='0'");
...
?>
        ...
        <table  class="table table-responsive">
                ...
                while($row=mysqli_fetch_assoc($result)){
                   ...
                   echo '<td><form method="post" action="unregisteredadmin.php">';
                  
                   echo '<input type="hidden" name="checkbox" value='.$row['username'].'>';
