...
<div class="sidebar-nav-fixed affix">
	...
	<?php
						...
						@$doctor_location=$_POST['location'];
						@$doctor_specialization=$_POST['specialization'];


						if($doctor_fees!=null && $doctor_specialization==null && $doctor_location==null){

					 $query="SELECT * FROM `doctors` where docFees like '$doctor_fees%'";
...
echo " reviews)";
					...
					if($doctor_location!=null && $doctor_specialization==null && $doctor_fees==null){

					 $queryLocation="SELECT * FROM `doctors` where area like '$doctor_location' ";
...
echo " reviews)";
					...
					if($doctor_specialization!=null && $doctor_location==null && $doctor_fees==null){

					$query="SELECT * FROM `doctors` where specilization like '$doctor_specialization%' ";
					$result=mysqli_query($con,$query);
...
if($doctor_location!=null && $doctor_specialization!=null && $doctor_fees==null){
					 ...
					 $queryLocation="SELECT * FROM `doctors` where area like '$doctor_location' AND specilization like '$doctor_specialization%' ";
					 $resultLocation=mysqli_query($con,$queryLocation);
while($row = mysqli_fetch_assoc($resultLocation))
								{
...
if($doctor_location!=null && $doctor_specialization==null && $doctor_fees!=null){
					 ...
					 $queryLocation="SELECT * FROM `doctors` where docFees like '$doctor_fees' AND area like '$doctor_location%' ";
					 $resultLocation=mysqli_query($con,$queryLocation);
while($row = mysqli_fetch_assoc($resultLocation))
								{
...
if($doctor_location==null && $doctor_specialization!=null && $doctor_fees!=null){
					 ...
					 $queryLocation="SELECT * FROM `doctors` where docFees like '$doctor_fees' AND specilization like '$doctor_specialization%' ";
					 $resultLocation=mysqli_query($con,$queryLocation);
while($row = mysqli_fetch_assoc($resultLocation))
								{
...
if($doctor_location!=null && $doctor_specialization!=null && $doctor_fees!=null){
					 ...
					 $queryLocation="SELECT * FROM `doctors` where area like '$doctor_location' AND specilization like '$doctor_specialization%' AND docFees like '$doctor_fees' ";
					 $resultLocation=mysqli_query($con,$queryLocation);
while($row = mysqli_fetch_assoc($resultLocation))
								{
