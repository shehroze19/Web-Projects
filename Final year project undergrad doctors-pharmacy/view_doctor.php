	...
	<?php
					...
					$result=mysqli_query($con,$query);
								...
								while($row = mysqli_fetch_assoc($result))
								{
									...
									echo "<a href='all_doctors.php' style='color:black;'><button class='btn btn-danger'>Go Back</button></a>";
									...
									echo "<h4 class='text-center'><b>Rating</b> <br><br>";
									$doc=$row['username'];
...
echo " reviews)";
								...
								<h4 class='text-center '><a href='booking.php?id=".$row['id']."'><button class='btn btn-info'>Book an Appointment</button></a></h4><hr>
