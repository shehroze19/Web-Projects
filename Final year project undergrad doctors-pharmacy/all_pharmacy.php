						...
						<div class="collapse navbar-collapse" id="myNavbar">
							<ul class="nav navbar-nav">
								...
								<div class="dropdown navbar-left hidden-md hidden-lg">
									...
									<div class="dropdown navbar-left hidden-xs hidden-sm">
										<li class="dropbtn">Search Pharmacy <i class="fa fa-search"></i></b></li>
										<div class="dropdown-content">
									...
									<div class="sidebar-nav-fixed affix">
										<div class="well">
											<ul class="nav ">
												...
												<br>
												<li class=""><a href="all_pharmacy_search.php?symbol=">All</a></li>
								...
								<div class="col-md-10">
									<div class="row table-bordered">
										...
										while($row = mysqli_fetch_assoc($result))
										{
											...
											<h6 class='text-center'>Phone :<b> ".$row['phone']."</b></h6></div></div>";
