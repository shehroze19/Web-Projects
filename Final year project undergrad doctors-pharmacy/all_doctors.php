					...
					<div style="padding-top: 100px;" class="">
							...
							<div class="sidebar-nav-fixed affix">
								<div class="well">
									<ul class="nav ">
										...
										<br>
										<li class=""><a href="all_doctors_search.php?symbol=">All</a></li>
						...
						<div class="col-md-10">
							<div class="row table-bordered">
								...
								$query="SELECT * FROM `doctors` where updatedInfo!='' order by doctorName  ";
								...
								<div class="sidebar-nav-fixed affix">
									<div class="well">
										<ul class="nav ">
											...
											<li class="active"><a href="all_doctors_search.php?symbol=">All</a></li>
