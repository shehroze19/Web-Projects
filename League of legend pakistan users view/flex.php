...
<form action="flex_add.php" method="post">
...
<div><h2 class="text-center">Flex Ladder EUW</h2></div>
...
<th class="text-center">OP GG</th>
					...
					<?php
					$query="SELECT * FROM `flex` ORDER BY position DESC ";
					...
					while($row = mysqli_fetch_assoc($result))
					{
						...
						echo "<td class='text-center'><a class='btn btn-success'  href='update_flex.php?id=".$row['Name']."'></td>";
