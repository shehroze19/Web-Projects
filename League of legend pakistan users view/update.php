...
$query2="DELETE FROM `soloq` WHERE `Name`='$id' ";
...
$query="INSERT INTO `soloq`(`Name`, `Division`, `Rank`, `Lp`, `wins`, `loss`, `winrate`, `position`) VALUES ('$sum_name','$tier','$rank','$lp','$wins','$loss','$winrate','$position');";
        ...
        if($runner){
            ...
            header("Location: soloq.php");
            
        }
        else{
            echo "<div class='btn btn-block alert-danger'>Error Record Already Exists or is unraked</div>";
            echo "<a href='soloq.php'><div class='btn btn-block alert-danger'>Go Back</div></a>";
