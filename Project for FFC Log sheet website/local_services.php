...
<body>
	...
	<div class="container">
		...
		<form class="form-text" action="local_servicescomplete.php" method="post">
			...
			<div class="form-group row"><label  class="col-2 col-form-label">Date</label>
				...
				<div class="form-group row"><label  class="col-2 col-form-label">Internet</label>
					<input class="form-control"  type="text" name="internet" required></div>


					<div class="form-group row"><label  class="col-2 col-form-label">Website</label>
						<input class="form-control"  type="text" name="web" required></div>


						<div class="form-group row"><label  class="col-2 col-form-label">Email</label>
							<input class="form-control"  type="text" name="email" required></div>


							<div class="form-group row"><label  class="col-2 col-form-label">Telephone</label>
								<input class="form-control"  type="text" name="tele" required></div>



								<div class="form-group row"><label  class="col-2 col-form-label">Comments </label>
									<input class="form-control"  type="text" name="comments" required></div>
