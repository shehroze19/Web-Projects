...
<body>
	...
	<div class="container">
		...
		<div class="page-header text-center">
			<h2>DATA CENTER ACCESS LOG SHEET</h2>
		...
		<form class="form-text" action="data_center_access_log_sheetcomplete.php" method="post">
			...
			<div class="container">
				...
				<div class="form-group row"><label  class="col-2 col-form-label">DATE</label>
					...
					<div class="form-group row"><label  class="col-2 col-form-label">NAME </label>
						...
						<div class="form-group row"><label  class="col-2 col-form-label">DEPARTMENT/SECTION</label>
							<input class="form-control" type="text" name="department" required ></div>


							<div class="form-group row"><label  class="col-2 col-form-label">REASON</label>
								...
								<div class="form-group row"><label  class="col-2 col-form-label">ACCOMPANIED BY</label>
									<input class="form-control" type="text" name="accompanied_by" required ></div>



									<div class="form-group row"><label  class="col-2 col-form-label">AUTHORIZED BY</label>
										<input class="form-control" type="text" name="authorized_by" required ></div>




										<div class="form-group row"><label  class="col-2 col-form-label">REVIEWED BY</label>
											<input class="form-control" type="text" name="review" required ></div>
									...
									<div>
										...
										<h6 class="text-center">b) In case of partial/full shut down, QPM must be followed, and all concerned personals must be notified.</h6>
