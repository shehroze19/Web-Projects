...
<body>
	...
	<div class="container">
		...
		<div class="page-header text-center">
			<h2>MD FLOOR TESTING LOG SHEET</h2>

			<h4 class="text-right">Internal Use Only</h4>
		</div>


		<form class="form-text" action="MD_FLOOR_TESTING_LOG_SHEET (COMPLETE).php" method="post">
			...
			<div class="container">
				...
				<div class="form-group row"><label  class="col-2 col-form-label">DATE</label>
					...
					<div class="form-group row"><label  class="col-2 col-form-label">REPORTED BY</label>
						<input class="form-control" value="<?php  echo $_SESSION['Name'];  ?>" type="text" name="reported_by" readonly></div>
						...
						<div class="form-group row"><label  class="col-2 col-form-label">WIFI</label>

							<input type='hidden' value='no' name='wifi'>
							<input class="form-control" type="checkbox" value="yes" name="wifi" >
						</div>

						<div class="form-group row"><label  class="col-2 col-form-label">INTERNET</label>
							<input type='hidden' value='no' name='internet'>
							<input class="form-control" type="checkbox" value="yes" name="internet" >
						</div>

						<div class="form-group row"><label  class="col-2 col-form-label">DOCKING STATION</label>
							<input type='hidden' value='no' name='docking_station'>
							<input class="form-control" type="checkbox" value="yes" name="docking_station" >
						</div>

						<div class="form-group row"><label  class="col-2 col-form-label">TELEPHONE</label>
							<input type='hidden' value='no' name='telephone'>
							<input class="form-control" type="checkbox" value="yes" name="telephone" >
						</div>

						<div class="form-group row"><label  class="col-2 col-form-label">REASON (if any)</label>
